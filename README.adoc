...
=== for multiple repositories, onboard the specific repositories
...
=== when multiple repo belongs to the same org, add integration for the repositories 
...
=== integrate the repositories in a GitHub Enterprise Server
